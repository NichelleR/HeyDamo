...
var mims_svg = d3.select("#mims_word_dataviz")
  .append("svg")
    .attr("width", width)
    .attr("height", height)


    d3.csv("https://raw.githubusercontent.com/NichelleR/ReasonsWhy/master/Resources/nichelle_df.csv", function(data) {
  ...
  var color = d3.scaleOrdinal()
    .domain(function(d){ return d.word})
  ...
  var MiMs_Tooltip = d3.select("#mims_word_dataviz")
    .append("div")
    .style("opacity", 0)
    .attr("class", "tooltip")
  ...
  var mims_mouseover = function(d) {
    MiMs_Tooltip
      .style("opacity", 1)
      .style("visibility", "visible")
  }
  var mims_mousemove = function(d) {
    MiMs_Tooltip
  ...
  var mims_mouseleave = function(d) {
    MiMs_Tooltip
      .style("opacity", 0)
      .style("visibility", "hidden")
  }

  var node = mims_svg.append("g")
    .selectAll("circle")
    .data(data)
    .enter()
    .append("circle")
      ...
      .on("mouseover", mims_mouseover) // What to do when hovered
      .on("mousemove", mims_mousemove)
      .on("mouseleave", mims_mouseleave)
...
mims_svg
  .append("text")
    ...
    .attr("y", height-90)
    .attr("width", 90)
    .html("Distribution of words MiMs has used")
mims_svg
  .append("text")
    .attr("text-anchor", "end")
    .style("fill", "#ffffff")
